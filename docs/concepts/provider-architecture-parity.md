...
This page records the provider architecture introduced on the v2 simplification
branch and the compatibility decisions verified on June 7, 2026. The measured
baseline is commit `0212d8833cba`, immediately before the shared native-client
factory migration.
